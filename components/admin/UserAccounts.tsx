  ...
  return (
    <>
      ...
      <div className="p-6 ">
        ...
        <table className="w-full border  text-sm  text-black text-normal  ">
          <thead className="bg-gray-100 ">
            <tr className="font-bold">
              {[
                ...
                <th
                  key={h}
                  className="border px-3 py-2 text-left bg-white text-normal text-black "
                >
                  {h}
                </th>
              ))}
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div className="bg-white text-black rounded-lg p-6 w-full max-w-md shadow-xl">
              <h2 className="tex-lg font-bold mb-4">
