  ...
  return (
    <div className="space-y-6 md:space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
      ...
      <div className="flex flex-col gap-1 px-1">
        <h3 className="text-xl font-black text-slate-800 dark:text-white tracking-tight">Notification Preferences</h3>
      ...
      {/* FOOTER ACTION */}
      <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between px-1">
