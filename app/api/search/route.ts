...
function navItemsForRole(role: string): Omit<SearchHit, "score">[] {
  ...
  if (role === "student") {
    return [
      ...
      {
        id: "nav-student-settings-account",
        category: "Settings",
        title: "Settings",
        subtitle: "Account preferences",
        href: "/student/home?openSettings=1&settings=account",
      },
      {
        id: "nav-student-settings-appearance",
        category: "Settings",
        title: "Appearance settings",
        subtitle: "Theme and UI preferences",
        href: "/student/home?openSettings=1&settings=appearance",
      },
      {
        id: "nav-student-settings-notifications",
        category: "Settings",
        title: "Notification settings",
        subtitle: "Alerts and push preferences",
        href: "/student/home?openSettings=1&settings=notifications",
      },
      {
        id: "nav-student-settings-security",
        category: "Settings",
        title: "Security settings",
        subtitle: "Password and session controls",
        href: "/student/home?openSettings=1&settings=security",
      },
      {
  ...
  if (role === "admin") {
    return [
      ...
      },
      {
        ...
        category: "Pages",
        title: "Profile",
        subtitle: "Account and admin profile",
        href: "/admin/profile",
      },
      {
        ...
        title: "Settings",
        subtitle: "Account preferences",
        href: "/admin/home?openSettings=1&settings=account",
      },
      {
        id: "nav-admin-settings-appearance",
        category: "Settings",
        title: "Appearance settings",
        subtitle: "Theme and UI preferences",
        href: "/admin/home?openSettings=1&settings=appearance",
      },
      {
        id: "nav-admin-settings-notifications",
        category: "Settings",
        title: "Notification settings",
        subtitle: "Alerts and push preferences",
        href: "/admin/home?openSettings=1&settings=notifications",
      },
      {
        id: "nav-admin-settings-security",
        category: "Settings",
        title: "Security settings",
        subtitle: "Password and session controls",
        href: "/admin/home?openSettings=1&settings=security",
      },
      help,
    ];
  }
  if (role === "signatory") {
    return [
      ...
      },
      {
        ...
        category: "Pages",
        title: "Profile",
        subtitle: "Account and signatory profile",
        href: "/signatory/profile",
      },
      {
        id: "nav-sig-settings-account",
        category: "Settings",
        title: "Settings",
        subtitle: "Account preferences",
        href: "/signatory/home?openSettings=1&settings=account",
      },
      {
        id: "nav-sig-settings-appearance",
        category: "Settings",
        title: "Appearance settings",
        subtitle: "Theme and UI preferences",
        href: "/signatory/home?openSettings=1&settings=appearance",
      },
      {
        id: "nav-sig-settings-notifications",
        category: "Settings",
        title: "Notification settings",
        subtitle: "Alerts and push preferences",
        href: "/signatory/home?openSettings=1&settings=notifications",
      },
      {
        id: "nav-sig-settings-security",
        category: "Settings",
        title: "Security settings",
        subtitle: "Password and session controls",
        href: "/signatory/home?openSettings=1&settings=security",
      },
      help,
    ];
  }
